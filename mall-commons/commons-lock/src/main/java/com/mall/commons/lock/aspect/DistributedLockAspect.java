package com.mall.commons.lock.aspect;

import com.mall.commons.lock.DistributedLock;
import com.mall.commons.lock.annotation.CustomerLock;
import com.mall.commons.lock.extension.ExtensionLoader;
...
public class DistributedLockAspect {
    ...
    //切入点：有这个注解的方法
    @Pointcut("@annotation(com.mall.commons.lock.annotation.CustomerLock)")
